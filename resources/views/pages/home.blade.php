...
new #[Layout('layouts.site')] #[Title('Northstar Studio')] class extends Component {
    //
};
?>

<livewire:layouts::marketing>
    ...
    <livewire:slot name="footer">Northstar Studio. A seeded Livewire SFC workbench scaffold.</livewire:slot>
</livewire:layouts::marketing>
